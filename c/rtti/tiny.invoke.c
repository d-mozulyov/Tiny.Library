...
#define arm64prefix48 register void* x4 asm("x4") = code_address; register native_int x8 asm("x8") = dumpregs.RegX8;
#define arm64gen(n) register native_int x##n asm("x" #n) = dumpregs.RegX##n;
